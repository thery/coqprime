...
\label{fig:TimeComp}
\end{figure} 
Still we were not capable to apply the two-level approach to larger numbers 
(> 1000 digits) as the millenium prime.
This was also true when applying the Lucas-Lehmer test
...
The idea was then to use our new library.
