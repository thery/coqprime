...
Theorem divide_Zdivide: forall p q, (divide p q) -> (Z_of_nat p | Z_of_nat q).
intros p q (r, Hr); exists (Z_of_nat r); subst; rewrite Zmult_comm; apply inj_mult.
Qed.
...
Theorem Zpower_pow_2: forall n, Zpower_nat 2 n = Z_of_nat (pow 2 n).
intros n; elim n; simpl; auto.
intros n1 Rec; rewrite plus_0_r; rewrite inj_plus; rewrite <- Rec.
rewrite S_to_plus_one; rewrite Zpower_nat_is_exp.
