...
unfold w8_1_op; apply mk_znz2_spec.
exact w8_op_spec.
...
unfold w8_5_op; apply mk_znz2_karatsuba_spec.
exact S4.
assert (S6: znz_spec w8_6_op).
unfold w8_6_op; apply mk_znz2_karatsuba_spec.
exact S5.
assert (S7: znz_spec w8_7_op).
unfold w8_7_op; apply mk_znz2_karatsuba_spec.
exact S6.
assert (S8: znz_spec w8_8_op).
unfold w8_8_op; apply mk_znz2_karatsuba_spec.
exact S7.
assert (S9: znz_spec w8_9_op).
unfold w8_9_op; apply mk_znz2_karatsuba_spec.
exact S8.
assert (S10: znz_spec w8_10_op).
unfold w8_10_op; apply mk_znz2_karatsuba_spec.
exact S9.
assert (S11: znz_spec w8_11_op).
unfold w8_11_op; apply mk_znz2_karatsuba_spec.
exact S10.
assert (S12: znz_spec w8_12_op).
unfold w8_12_op; apply mk_znz2_karatsuba_spec.
exact S11.
assert (S13: znz_spec w8_13_op).
unfold w8_13_op; apply mk_znz2_karatsuba_spec.
exact S12.
assert (S14: znz_spec w8_14_op).
unfold w8_14_op; apply mk_znz2_karatsuba_spec.
exact S13.
intros n; case n; clear n.
exact w8_op_spec.
intros n; case n; clear n.
