...
Lemma ltprime_main : 
  ...
  forall k, ltprime 10 k -> k <= 357686312646216567629137.
Proof.
split.
  Time now ltprime_tac 10.
intros k kLt.
assert (H : k <= 357686312646216567629137 \/ 357686312646216567629137 < k) by lia.
...
replace 25 with (24 + 1) by lia.
apply no_zero_digit_log; try lia; auto; [|case kLt; auto].
