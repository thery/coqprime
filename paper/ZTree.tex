...
We will use $x,\ y$ for single-word variables and $xx,\ yy$ for
two-word variables. 
...
We will use the notation $w\_f$ for the single-word version of $f$ and 
...
does not produce any overhead. Building a binary tree structure or 
building the equivalent linear list of words requires the same number of cells.
